...
export { default as NestJS } from './Nest.js.png';
...
export { default as 'Google Cloud' } from './Google Cloud.png';
export { default as 'Tanstack Query' } from './tanstack-stacked-white.svg';
